...
use App\Http\Controllers\{HomeController, JobController, CompanyController, NotificationController, LanguageController, SettingsController};
use App\Http\Controllers\User\{ProfileController as UserProfileController, ApplicationController as UserApplicationController};
use App\Http\Controllers\Company\{DashboardController as CompanyDashboardController, JobController as CompanyJobController, ApplicationController as CompanyApplicationController, ProfileController as CompanyProfileController, ReviewController};
use App\Http\Controllers\Admin\{DashboardController as AdminDashboardController, UserController as AdminUserController, CompanyController as AdminCompanyController, JobController as AdminJobController, NotificationController as AdminNotificationController};
...
Route::prefix('jobs')->name('jobs.')->group(function () {
    ...
    Route::get('/recommended/api', [JobController::class, 'recommendedApi'])->name('recommended.api')->middleware('auth');
...
Route::get('/settings/export-data', [SettingsController::class, 'exportData'])->name('settings.export-data');
    ...
    Route::middleware('role:company')->prefix('company')->name('company.')->group(function () {
        ...
        Route::prefix('applications')->name('applications.')->group(function () {
            ...
            Route::get('/rank/{job}', [CompanyApplicationController::class, 'rankApi'])->name('rank');
        });

        // ← اسم بسيط يطابق السايدبار: company.reviews
