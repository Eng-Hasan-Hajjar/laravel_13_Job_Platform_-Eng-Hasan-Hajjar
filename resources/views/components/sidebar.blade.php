    ...
    <nav class="sidebar-nav">
        ...
        @if($user->role === 'user')
            ...
            <div class="sidebar-section">
                ...
                <a href="{{ route('jobs.index') }}" class="sidebar-item {{ str_starts_with($route,'jobs.') && $route !== 'jobs.recommended' ? 'active' : '' }}">
                    <i class="fas fa-briefcase"></i>
                    <span>{{ __('messages.browse_jobs') }}</span>
                </a>
                <a href="{{ route('jobs.recommended') }}" class="sidebar-item {{ $route === 'jobs.recommended' ? 'active' : '' }}">
            ...
            <div class="sidebar-section">
                ...
                <a href="{{ route('user.applications') }}" class="sidebar-item {{ str_starts_with($route,'user.application') ? 'active' : '' }}">
                ...
                <a href="{{ route('user.saved-jobs') }}" class="sidebar-item {{ $route === 'user.saved-jobs' ? 'active' : '' }}">
            ...
            <div class="sidebar-section">
                ...
                <a href="{{ route('companies.index') }}" class="sidebar-item {{ str_starts_with($route,'companies.') ? 'active' : '' }}">
        ...
        @elseif($user->role === 'company')
            ...
            <div class="sidebar-section">
                ...
                <a href="{{ route('company.dashboard') }}" class="sidebar-item {{ $route === 'company.dashboard' ? 'active' : '' }}">
            ...
            <div class="sidebar-section">
                ...
                <a href="{{ route('company.jobs.index') }}" class="sidebar-item {{ str_starts_with($route,'company.jobs.') && $route !== 'company.jobs.create' ? 'active' : '' }}">
                    <i class="fas fa-briefcase"></i>
                    <span>{{ __('messages.my_jobs') }}</span>
                </a>
                <a href="{{ route('company.jobs.create') }}" class="sidebar-item {{ $route === 'company.jobs.create' ? 'active' : '' }}">
            ...
            <div class="sidebar-section">
                ...
                <a href="{{ route('company.applications.index') }}" class="sidebar-item {{ str_starts_with($route,'company.applications.') ? 'active' : '' }}">
            ...
            <div class="sidebar-section">
                ...
                <a href="{{ route('company.profile') }}" class="sidebar-item {{ $route === 'company.profile' ? 'active' : '' }}">
                    <i class="fas fa-building"></i>
                    <span>{{ __('messages.company_profile') }}</span>
                </a>
                <a href="{{ route('company.reviews') }}" class="sidebar-item {{ str_starts_with($route,'company.reviews') ? 'active' : '' }}">
        ...
        @elseif($user->role === 'admin')
            ...
            <div class="sidebar-section">
                ...
                <a href="{{ route('admin.dashboard') }}" class="sidebar-item {{ $route === 'admin.dashboard' ? 'active' : '' }}">
                    <i class="fas fa-tachometer-alt"></i>
            ...
            <div class="sidebar-section">
                ...
                <a href="{{ route('admin.companies.index') }}" class="sidebar-item {{ str_starts_with($route,'admin.companies.') ? 'active' : '' }}">
                    <i class="fas fa-building"></i>
                    <span>{{ __('messages.companies') }}</span>
                </a>
                <a href="{{ route('admin.jobs.index') }}" class="sidebar-item {{ str_starts_with($route,'admin.jobs.') ? 'active' : '' }}">
                    <i class="fas fa-briefcase"></i>
            ...
            <div class="sidebar-section">
                ...
                <a href="{{ route('admin.notifications.index') }}" class="sidebar-item {{ str_starts_with($route,'admin.notifications.') ? 'active' : '' }}">
                    <i class="fas fa-bell"></i>
                    <span>{{ __('messages.notifications') }}</span>
                </a>
                <a href="{{ route('admin.settings') }}" class="sidebar-item {{ $route === 'admin.settings' ? 'active' : '' }}">
        ...
        <div class="sidebar-section">
            ...
            <a href="{{ route('notifications.index') }}" class="sidebar-item {{ $route === 'notifications.index' ? 'active' : '' }}">
                <i class="fas fa-bell"></i>
                <span>{{ __('messages.notifications') }}</span>
